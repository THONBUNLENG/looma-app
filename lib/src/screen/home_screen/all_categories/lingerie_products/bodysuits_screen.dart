...
class BodysuitsScreen extends StatefulWidget {
  ...
  @override
  State<BodysuitsScreen> createState() => _BodysuitsScreenState();
}

class _BodysuitsScreenState extends State<BodysuitsScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredBodysuits;

  @override
  void initState() {
    super.initState();
    _filteredBodysuits = widget.bodysuitProduct;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredBodysuits.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredBodysuits.length,
                    itemBuilder: (context, index) {
                      final item = _filteredBodysuits[index];
                      return GestureDetector(
                        ...
                        child: _buildBodysuitCard(context, item, isDark),
                      );
                    },
                  ),
          ),
              ...
              Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "|",
                      style: TextStyle(color: subTextColor.withValues(alpha: 0.3)),
                    ),
                  ),
                  Text(
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.checkroom_outlined : Icons.search_off_rounded,
            size: 70,
