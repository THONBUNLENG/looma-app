...
class NightwearScreen extends StatefulWidget {
  final String categoryName;
  final List<Map<String, String>> nightwearProducts;

  const NightwearScreen({
    super.key,
  ...
  @override
  State<NightwearScreen> createState() => _NightwearScreenState();
}

class _NightwearScreenState extends State<NightwearScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, String>> _filteredNightwear;

  @override
  void initState() {
    super.initState();
    _filteredNightwear = widget.nightwearProducts;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredNightwear.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredNightwear.length,
                    itemBuilder: (context, index) {
                      final item = _filteredNightwear[index];
                      return _buildNightwearCard(context, item, isDark);
                    },
                  ),
          ),
        ],
                ...
                children: [
                  Positioned.fill(
                    child: CachedNetworkImage(
                      ...
                      errorWidget: (context, url, error) => const Icon(Icons.nightlight_round_outlined),
                    ),
                  ),
                  Positioned(
                    top: 10,
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.bedtime_outlined : Icons.search_off_rounded,
            size: 70,
            color: isDark ? Colors.white10 : Colors.grey[300],
          ),
          const SizedBox(height: 16),
          TextWidget(
            _searchQuery.isEmpty ? "No nightwear available".tr : "No results for '$_searchQuery'".tr,
