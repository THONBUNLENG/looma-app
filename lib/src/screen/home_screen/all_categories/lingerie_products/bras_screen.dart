...
class BrasScreen extends StatefulWidget {
  ...
  @override
  State<BrasScreen> createState() => _BrasScreenState();
}

class _BrasScreenState extends State<BrasScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, String>> _filteredBras;

  @override
  void initState() {
    super.initState();
    _filteredBras = widget.braProducts;
  }
          ...
          Expanded(
            child: _filteredBras.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredBras.length,
                    itemBuilder: (context, index) {
                      final item = _filteredBras[index];
                      return _buildBraCard(context, item, isDark);
                    },
                  ),
          ),
        ],
