...
class ShapewearScreen extends StatefulWidget {
  ...
  @override
  State<ShapewearScreen> createState() => _ShapewearScreenState();
}

class _ShapewearScreenState extends State<ShapewearScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, String>> _filteredShapewear;

  @override
  void initState() {
    super.initState();
    _filteredShapewear = widget.shapewearProducts;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredShapewear.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredShapewear.length,
                    itemBuilder: (context, index) {
                      final item = _filteredShapewear[index];
                      return _buildShapewearCard(context, item, isDark);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.accessibility_new_outlined : Icons.search_off_rounded,
            size: 70,
