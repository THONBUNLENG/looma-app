...
class _SocksScreenState extends State<SocksScreen> {
  ...
  String _searchQuery = "";
  late List<Map<String, String>> _filteredSocks;

  @override
  void initState() {
    super.initState();
    _filteredSocks = widget.sockProducts;
  }
            ...
            child: _filteredSocks.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final item = _filteredSocks[index];
                      return _buildSocksCard(context, item, isDark);
                    },
                  ),
          ),
        ],
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          TextWidget(
            _searchQuery.isEmpty ? "No socks available".tr : "No results for '$_searchQuery'".tr,
