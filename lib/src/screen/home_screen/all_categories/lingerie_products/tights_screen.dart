...
class TightsScreen extends StatefulWidget {
  ...
  @override
  State<TightsScreen> createState() => _TightsScreenState();
}

class _TightsScreenState extends State<TightsScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, String>> _filteredTights;

  @override
  void initState() {
    super.initState();
    _filteredTights = widget.tightsProducts;
  }
          ...
          Expanded(
            child: _filteredTights.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredTights.length,
                    itemBuilder: (context, index) {
                      final item = _filteredTights[index];
                      return _buildTightsCard(context, item, isDark);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.shopping_basket_outlined : Icons.search_off_rounded,
            size: 70,
            color: isDark ? Colors.white10 : Colors.grey[300],
          ),
          const SizedBox(height: 16),
          TextWidget(
            _searchQuery.isEmpty ? "No tights available".tr : "No results for '$_searchQuery'".tr,
