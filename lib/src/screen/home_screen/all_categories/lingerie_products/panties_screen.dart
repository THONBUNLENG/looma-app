...
class PantiesScreen extends StatefulWidget {
  ...
  @override
  State<PantiesScreen> createState() => _PantiesScreenState();
}

class _PantiesScreenState extends State<PantiesScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, String>> _filteredPanties;

  @override
  void initState() {
    super.initState();
    _filteredPanties = widget.pantyProducts;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredPanties.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredPanties.length,
                    itemBuilder: (context, index) {
                      final item = _filteredPanties[index];
                      return _buildPantyCard(context, item, isDark);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.auto_awesome_outlined : Icons.search_off_rounded,
            size: 70,
            color: isDark ? Colors.white10 : Colors.grey[300],
          ),
          const SizedBox(height: 16),
          TextWidget(
            _searchQuery.isEmpty ? "No items available".tr : "No results for '$_searchQuery'".tr,
