...
class _JewelryScreenState extends State<JewelryScreen> {
  late List<Map<String, dynamic>> _filteredAccessories;
  ...
  void initState() {
    super.initState();
    _filteredAccessories = widget.accessories;
  }
            ...
            child: _filteredAccessories.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final item = _filteredAccessories[index];
                      return _buildJewelryCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
