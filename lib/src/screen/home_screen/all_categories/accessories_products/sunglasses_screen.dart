...
class _SunglassesScreenState extends State<SunglassesScreen> {
  late List<Map<String, dynamic>> _filteredSunglasses;
  ...
  void initState() {
    super.initState();
    _filteredSunglasses = widget.sunglasses;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredSunglasses.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredSunglasses.length,
                    itemBuilder: (context, index) {
                      final item = _filteredSunglasses[index];
                      return _buildSunglassesCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
