...
import 'package:shopping_app/src/screen/home_screen/card/product_jewelry_screen.dart';
...
class ScarvesScreen extends StatefulWidget {
  ...
  @override
  State<ScarvesScreen> createState() => _ScarvesScreenState();
}

class _ScarvesScreenState extends State<ScarvesScreen> {
  late List<Map<String, dynamic>> _filteredScarves;
  ...
  void initState() {
    super.initState();
    _filteredScarves = widget.scarves;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredScarves.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredScarves.length,
                    itemBuilder: (context, index) {
                      final item = _filteredScarves[index];
                      return _buildScarfCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
