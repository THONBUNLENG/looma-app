...
class HatsScreen extends StatefulWidget {
  ...
  const HatsScreen({super.key, required this.categoryName, required this.hats});
...
class _HatsScreenState extends State<HatsScreen> {
  late List<Map<String, dynamic>> _filteredHats;
  ...
  void _onSearchChanged(String query) {
    setState(() {
      ...
      _filteredHats = widget.hats
          .where(
            (hat) => (hat['title'] ?? '').toLowerCase().contains(
              query.toLowerCase(),
            ),
          )
          .toList();
          ...
          Expanded(
            child: _filteredHats.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredHats.length,
                    itemBuilder: (context, index) {
                      final item = _filteredHats[index];
                      return _buildHatCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
