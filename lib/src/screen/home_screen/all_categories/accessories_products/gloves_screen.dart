...
class GlovesScreen extends StatefulWidget {
  ...
  @override
  State<GlovesScreen> createState() => _GlovesScreenState();
}

class _GlovesScreenState extends State<GlovesScreen> {
  late List<Map<String, dynamic>> _filteredGloves;
  ...
  void initState() {
    super.initState();
    _filteredGloves = widget.gloves;
  }

  void _filterGloves(String query) {
    setState(() {
      _searchQuery = query;
      if (query.isEmpty) {
        _filteredGloves = widget.gloves;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [_buildCartAction(isDark)],
          ...
          Expanded(
            child: _filteredGloves.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredGloves.length,
                    itemBuilder: (context, index) {
                      final item = _filteredGloves[index];
                      return _buildGloveCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
  ...
  PreferredSizeWidget _buildPromoBanner(bool isDark) {
