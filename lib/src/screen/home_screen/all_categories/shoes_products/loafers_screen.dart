...
class LoafersScreen extends StatefulWidget {
  ...
  @override
  State<LoafersScreen> createState() => _LoafersScreenState();
}

class _LoafersScreenState extends State<LoafersScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredLoafers;

  @override
  void initState() {
    super.initState();
    _filteredLoafers = widget.loafers;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredLoafers.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredLoafers.length,
                    itemBuilder: (context, index) {
                      final item = _filteredLoafers[index];
                      return _buildLoaferCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.business_center_outlined : Icons.search_off_rounded,
            size: 70,
            color: isDark ? Colors.white10 : Colors.grey[300],
          ),
          const SizedBox(height: 16),
          TextWidget(
            _searchQuery.isEmpty ? "No loafers available" : "No results for '$_searchQuery'",
