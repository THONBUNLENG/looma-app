...
class SandalsScreen extends StatefulWidget {
  ...
  @override
  State<SandalsScreen> createState() => _SandalsScreenState();
}

class _SandalsScreenState extends State<SandalsScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredSandals;

  @override
  void initState() {
    super.initState();
    _filteredSandals = widget.sandals;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredSandals.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredSandals.length,
                    itemBuilder: (context, index) {
                      final item = _filteredSandals[index];
                      return _buildSandalCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.beach_access_outlined : Icons.search_off_rounded,
            size: 70,
            color: isDark ? Colors.white10 : Colors.grey[300],
          ),
          const SizedBox(height: 16),
          TextWidget(
            _searchQuery.isEmpty ? "No sandals available".tr : "'No results for {0}'.trArgs([_searchQuery])",
