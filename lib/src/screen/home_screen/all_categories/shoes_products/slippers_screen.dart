...
class SlippersScreen extends StatefulWidget {
  final String categoryName;
  final List<Map<String, dynamic>> slippers;

  const SlippersScreen({
    super.key,
  ...
  @override
  State<SlippersScreen> createState() => _SlippersScreenState();
}

class _SlippersScreenState extends State<SlippersScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredSlippers;

  @override
  void initState() {
    super.initState();
    _filteredSlippers = widget.slippers;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredSlippers.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredSlippers.length,
                    itemBuilder: (context, index) {
                      final item = _filteredSlippers[index];
                      return _buildSlipperCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.nightlight_round : Icons.search_off_rounded,
            size: 70,
            color: isDark ? Colors.white10 : Colors.grey[300],
          ),
          const SizedBox(height: 16),
          TextWidget(
            _searchQuery.isEmpty ? "No slippers available" : "No results for '$_searchQuery'",
