...
class HeelsScreen extends StatefulWidget {
  ...
  final List<Map<String, dynamic>> heels;
  ...
  @override
  State<HeelsScreen> createState() => _HeelsScreenState();
}

class _HeelsScreenState extends State<HeelsScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredHeels;

  @override
  void initState() {
    super.initState();
    _filteredHeels = widget.heels;
  }
          ...
          Expanded(
            child: _filteredHeels.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredHeels.length,
                    itemBuilder: (context, index) {
                      final item = _filteredHeels[index];
                      return _buildHeelsCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.auto_awesome_mosaic_outlined : Icons.search_off_rounded,
            size: 70,
