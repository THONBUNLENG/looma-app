...
class _SportsScreenState extends State<SportsScreen> {
  ...
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredSports;

  @override
  void initState() {
    super.initState();
    _filteredSports = widget.sportsShoes;
  }
            ...
            child: _filteredSports.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final item = _filteredSports[index];
                      return _buildSportsCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.sports_outlined : Icons.search_off_rounded,
            size: 80,
            color: isDark ? Colors.white10 : Colors.grey[200],
          ),
          const SizedBox(height: 16),
          TextWidget(
            _searchQuery.isEmpty ? "No sports items found".tr : "'No results for {0}'.trArgs([_searchQuery])",
