...
class _SneakersScreenState extends State<SneakersScreen> {
  ...
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredSneakers;

  @override
  void initState() {
    super.initState();
    _filteredSneakers = widget.sneakers;
  }
            ...
            child: _filteredSneakers.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final item = _filteredSneakers[index];
                      return _buildSneakerCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          TextWidget(
            _searchQuery.isEmpty ? "No sneakers found".tr : "'No results for {0}'.trArgs([_searchQuery])",
