...
class _BootsScreenState extends State<BootsScreen> {
  ...
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredBoots;

  @override
  void initState() {
    super.initState();
    _filteredBoots = widget.shoesBoots;
  }
          ...
          Expanded(
            child: _filteredBoots.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredBoots.length,
                    itemBuilder: (context, index) {
                      final item = _filteredBoots[index];
  ...
  Widget _buildShoeCard(
    ...
    final cardColor = isDark ? const Color(0xFF2D3037) : Colors.grey[100]!;
