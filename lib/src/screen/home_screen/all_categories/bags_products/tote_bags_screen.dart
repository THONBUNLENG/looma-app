...
class ToteBagsScreen extends StatefulWidget {
  final String categoryName;
  final List<Map<String, dynamic>> toteBags;

  const ToteBagsScreen({
    super.key,
  ...
  @override
  State<ToteBagsScreen> createState() => _ToteBagsScreenState();
}

class _ToteBagsScreenState extends State<ToteBagsScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredTotes;

  @override
  void initState() {
    super.initState();
    _filteredTotes = widget.toteBags;
  }
          ...
          Expanded(
            child: _filteredTotes.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredTotes.length,
                    itemBuilder: (context, index) {
                      final item = _filteredTotes[index];
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          TextWidget(
            _searchQuery.isEmpty ? "No tote bags found".tr : "No results for '$_searchQuery'".tr,
