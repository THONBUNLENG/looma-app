...
class _MessengerScreenState extends State<MessengerScreen> {
  ...
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredBags;

  @override
  void initState() {
    super.initState();
    _filteredBags = widget.messengerBags;
  }
            ...
            child: _filteredBags.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final item = _filteredBags[index];
                      return _buildMessengerCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.local_post_office_outlined : Icons.search_off_rounded,
            size: 70,
            color: isDark ? Colors.white10 : Colors.grey[300],
          ),
          const SizedBox(height: 16),
          TextWidget(
            _searchQuery.isEmpty ? "No messenger bags found".tr : "No results for '$_searchQuery'".tr,
