...
class ClutchesScreen extends StatefulWidget {
  ...
  @override
  State<ClutchesScreen> createState() => _ClutchesScreenState();
}

class _ClutchesScreenState extends State<ClutchesScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredClutches;
            ...
            child: _filteredClutches.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildClutchCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
