...
class _HandbagsScreenState extends State<HandbagsScreen> {
  ...
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredHandbags;

  @override
  void initState() {
    super.initState();
    _filteredHandbags = widget.handbags;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredHandbags.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredHandbags.length,
                    itemBuilder: (context, index) {
                      final item = _filteredHandbags[index];
                      return _buildHandbagCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
