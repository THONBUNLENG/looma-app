...
class _BackpacksScreenState extends State<BackpacksScreen> {
  late List<Map<String, dynamic>> _filteredBackpacks;
  ...
  void initState() {
    super.initState();
    _filteredBackpacks = widget.backpacks;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredBackpacks.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredBackpacks.length,
                    itemBuilder: (context, index) {
                      final item = _filteredBackpacks[index];
                      return _buildBackpackCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.backpack_outlined : Icons.search_off_rounded,
            size: 70,
            color: isDark ? Colors.white10 : Colors.grey[300],
          ),
          const SizedBox(height: 16),
          TextWidget(
            _searchQuery.isEmpty ? "No backpacks found".tr : "No results for '$_searchQuery'".tr,
