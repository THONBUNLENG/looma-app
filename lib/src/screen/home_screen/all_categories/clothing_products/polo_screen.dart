...
class _PoloScreenState extends State<PoloScreen> {
  ...
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredPolos;

  @override
  void initState() {
    super.initState();
    _filteredPolos = widget.polos;
  }
          ...
          Expanded(
            child: _filteredPolos.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredPolos.length,
                    itemBuilder: (context, index) {
                      final item = _filteredPolos[index];
                      return _buildPoloCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
