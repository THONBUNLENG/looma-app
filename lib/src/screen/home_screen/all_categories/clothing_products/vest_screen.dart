...
class VestScreen extends StatefulWidget {
  final String categoryName;
  final List<Map<String, dynamic>> vests;
  ...
  @override
  State<VestScreen> createState() => _VestScreenState();
}

class _VestScreenState extends State<VestScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredVests;

  @override
  void initState() {
    super.initState();
    _filteredVests = widget.vests;
  }
          ...
          Expanded(
            child: _filteredVests.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredVests.length,
                    itemBuilder: (context, index) {
                      final item = _filteredVests[index];
                      return _buildVestCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
