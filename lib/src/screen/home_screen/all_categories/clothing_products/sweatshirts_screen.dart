...
class SweatshirtsScreen extends StatefulWidget {
  final String categoryName;
  final List<Map<String, dynamic>> sweatshirts;

  const SweatshirtsScreen({
    super.key,
  ...
  @override
  State<SweatshirtsScreen> createState() => _SweatshirtsScreenState();
}

class _SweatshirtsScreenState extends State<SweatshirtsScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredSweatshirts;

  @override
  void initState() {
    super.initState();
    _filteredSweatshirts = widget.sweatshirts;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredSweatshirts.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredSweatshirts.length,
                    itemBuilder: (context, index) {
                      final item = _filteredSweatshirts[index];
                      return _buildSweatshirtCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.layers_outlined : Icons.search_off_rounded,
            size: 70,
