...
class _TshirtsScreenState extends State<TshirtsScreen> {
  ...
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredTshirts;

  @override
  void initState() {
    super.initState();
    _filteredTshirts = widget.tShirts;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredTshirts.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredTshirts.length,
                    itemBuilder: (context, index) {
                      final item = _filteredTshirts[index];
                      return _buildTshirtCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
