...
class ActivewearScreen extends StatefulWidget {
  final String categoryName;
  final List<Map<String, dynamic>> activewear;

  const ActivewearScreen({
    super.key,
  ...
  @override
  State<ActivewearScreen> createState() => _ActivewearScreenState();
}

class _ActivewearScreenState extends State<ActivewearScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredActivewear;

  @override
  void initState() {
    super.initState();
    _filteredActivewear = widget.activewear;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredActivewear.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredActivewear.length,
                    itemBuilder: (context, index) {
                      final item = _filteredActivewear[index];
                      return _buildActiveCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
