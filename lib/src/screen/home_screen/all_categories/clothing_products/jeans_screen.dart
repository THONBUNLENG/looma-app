...
class JeansScreen extends StatefulWidget {
  ...
  @override
  State<JeansScreen> createState() => _JeansScreenState();
}

class _JeansScreenState extends State<JeansScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredJeans;

  @override
  void initState() {
    super.initState();
    _filteredJeans = widget.jeans;
  }
          ...
          Expanded(
            child: _filteredJeans.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredJeans.length,
                    itemBuilder: (context, index) {
                      final item = _filteredJeans[index];
                      return _buildJeansCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          TextWidget(
            _searchQuery.isEmpty ? "No jeans found" : "No results found for '$_searchQuery'",
