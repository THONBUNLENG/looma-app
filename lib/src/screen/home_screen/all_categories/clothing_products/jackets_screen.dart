...
class _JacketsScreenState extends State<JacketsScreen> {
  ...
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredJackets;

  @override
  void initState() {
    super.initState();
    _filteredJackets = widget.jackets;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredJackets.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredJackets.length,
                    itemBuilder: (context, index) {
                      final item = _filteredJackets[index];
                      return _buildJacketCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          TextWidget(
            _searchQuery.isEmpty ? 'No Jackets found'.tr : "'No results found for {0}'.trArgs([_searchQuery])",
