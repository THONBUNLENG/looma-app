...
class LeggingsScreen extends StatefulWidget {
  ...
  @override
  State<LeggingsScreen> createState() => _LeggingsScreenState();
}

class _LeggingsScreenState extends State<LeggingsScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredLeggings;

  @override
  void initState() {
    super.initState();
    _filteredLeggings = widget.leggings;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredLeggings.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredLeggings.length,
                    itemBuilder: (context, index) {
                      final item = _filteredLeggings[index];
                      return _buildLeggingsCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
