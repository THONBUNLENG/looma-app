...
class JoggersScreen extends StatefulWidget {
  ...
  @override
  State<JoggersScreen> createState() => _JoggersScreenState();
}

class _JoggersScreenState extends State<JoggersScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredJoggers;

  @override
  void initState() {
    super.initState();
    _filteredJoggers = widget.joggers;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredJoggers.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredJoggers.length,
                    itemBuilder: (context, index) {
                      final item = _filteredJoggers[index];
                      return _buildJoggersCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          TextWidget(
            _searchQuery.isEmpty ? 'No joggers found'.tr : "'No results found for {0}'.trArgs([_searchQuery])",
