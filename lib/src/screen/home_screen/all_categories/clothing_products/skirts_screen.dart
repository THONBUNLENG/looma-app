...
class SkirtsScreen extends StatefulWidget {
  ...
  @override
  State<SkirtsScreen> createState() => _SkirtsScreenState();
}

class _SkirtsScreenState extends State<SkirtsScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredSkirts;

  @override
  void initState() {
    super.initState();
    _filteredSkirts = widget.skirts;
  }
          ...
          Expanded(
            child: _filteredSkirts.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredSkirts.length,
                    itemBuilder: (context, index) {
                      final item = _filteredSkirts[index];
                      return _buildSkirtsCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          TextWidget(
            _searchQuery.isEmpty ? "No skirts available" : "No results found for '$_searchQuery'",
