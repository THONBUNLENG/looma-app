...
class DresseScreen extends StatefulWidget {
  ...
  @override
  State<DresseScreen> createState() => _DresseScreenState();
}

class _DresseScreenState extends State<DresseScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredDresses;

  @override
  void initState() {
    super.initState();
    _filteredDresses = widget.dresses;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredDresses.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final item = _filteredDresses[index];
                      return _buildDressCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
