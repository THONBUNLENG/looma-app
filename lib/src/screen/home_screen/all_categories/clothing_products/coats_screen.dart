...
class CoatsScreen extends StatefulWidget {
  ...
  @override
  State<CoatsScreen> createState() => _CoatsScreenState();
}

class _CoatsScreenState extends State<CoatsScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredCoats;

  @override
  void initState() {
    super.initState();
    _filteredCoats = widget.coats;
  }
          ...
          Expanded(
            child: _filteredCoats.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredCoats.length,
                    itemBuilder: (context, index) {
                      final item = _filteredCoats[index];
                      return _buildCoatCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.ac_unit_outlined : Icons.search_off_rounded,
            size: 70,
          ...
          TextWidget(
            _searchQuery.isEmpty
                ? "Winter collection coming soon".tr
