...
class CardigansScreen extends StatefulWidget {
  final String categoryName;
  final List<Map<String, dynamic>> cardigans;

  const CardigansScreen({
    super.key,
  ...
  @override
  State<CardigansScreen> createState() => _CardigansScreenState();
}

class _CardigansScreenState extends State<CardigansScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredCardigans;

  @override
  void initState() {
    super.initState();
    _filteredCardigans = widget.cardigans;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _filteredCardigans.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredCardigans.length,
                    itemBuilder: (context, index) {
                      final item = _filteredCardigans[index];
                      return _buildCardiganCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.filter_hdr_outlined : Icons.search_off_rounded,
            size: 70,
