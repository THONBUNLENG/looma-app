...
class PantsProductsScreen extends StatefulWidget {
  final String categoryName;
  final List<Map<String, dynamic>> pants;

  const PantsProductsScreen({
    super.key,
  ...
  @override
  State<PantsProductsScreen> createState() => _PantsProductsScreenState();
}

class _PantsProductsScreenState extends State<PantsProductsScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredPants;

  @override
  void initState() {
    super.initState();
    _filteredPants = widget.pants;
  }
          ...
          Expanded(
            child: _filteredPants.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredPants.length,
                    itemBuilder: (context, index) {
                      final item = _filteredPants[index];
                      return _buildPantsCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          TextWidget(
            _searchQuery.isEmpty ? "No pants found" : "No results found for '$_searchQuery'",
