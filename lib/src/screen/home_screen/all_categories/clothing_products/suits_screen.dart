...
import '../../product_detail/product_clothes_screen.dart' show ProductClothesScreen;
...
class _SuitsScreenState extends State<SuitsScreen> {
  ...
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredSuits;

  @override
  void initState() {
    super.initState();
    _filteredSuits = widget.suits;
  }
            ...
            child: _filteredSuits.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final item = _filteredSuits[index];
                      return _buildSuitCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
  ...
  Widget _buildEmptyState(bool isDark) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _searchQuery.isEmpty ? Icons.work_outline : Icons.search_off_rounded,
            size: 70,
            color: isDark ? Colors.white10 : Colors.grey[300],
          ),
          const SizedBox(height: 16),
          TextWidget(
            _searchQuery.isEmpty ? 'No suits found'.tr : "'No results found for {0}'.trArgs([_searchQuery])",
