...
class _ShirtsScreenState extends State<ShirtsScreen> {
  ...
  String _searchQuery = "";
  late List<Map<String, dynamic>> _filteredShirts;

  @override
  void initState() {
    super.initState();
    _filteredShirts = widget.shirts;
  }
          ...
          Expanded(
            child: _filteredShirts.isEmpty
                ...
                : GridView.builder(
                    ...
                    itemCount: _filteredShirts.length,
                    itemBuilder: (context, index) {
                      final item = _filteredShirts[index];
                      return _buildShirtsCard(context, item, isDark, index);
                    },
                  ),
          ),
        ],
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          TextWidget(
            _searchQuery.isEmpty ? "No shirts found" : "No results found for '$_searchQuery'",
