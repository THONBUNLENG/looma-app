...
class LittlePrincessSection extends StatefulWidget {
  const LittlePrincessSection({super.key});

  @override
  State<LittlePrincessSection> createState() => _LittlePrincessSectionState();
}

class _LittlePrincessSectionState extends State<LittlePrincessSection> {
  ...
  void initState() {
    super.initState();
    _productStream = _firestoreService.getProducts(category: 'GIRLS');
  }
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => const UniversalProductScreen(
                        title: 'Little Princess Collection',
                        category: 'GIRLS',
                      ),
                    ),
                  );
...
class PrincessItemCard extends StatelessWidget {
  final ProductModel product;
  final int index;

  const PrincessItemCard({
    super.key,
